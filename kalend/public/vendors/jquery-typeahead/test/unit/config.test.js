...
describe('Typeahead Config Tests', () => {
    ...
    it('Should merge selectors', () => {
        expect(myTypeahead.options.selector.container).toEqual('typeahead-container-test');
        expect(myTypeahead.options.selector.result).toEqual('typeahead-result-test');
