        ...
        <div class="rts-hero-banner banner-six">
            <div class="container">
                <div class="row justify-content-md-center">
                    <div class="col-xl-7 col-lg-7 col-md-10 order-md-2 order-lg-0">
            ...
            <div class="hero-image-big">
                <img src="assets/images/banner/banner-hero-3.png" alt="{{ $banner->code }}">
            </div>
        </div>
    </section>
    <!-- HERO BANNER ONE END -->
        ...
        <div class="container">
            <div class="row">
                <div class="rts-cta-two__wrapper">
                    ...
                    <div class="cta-btn">
                        <a href="{{ route($contactSection->buttons[0]->redirect) }}"
