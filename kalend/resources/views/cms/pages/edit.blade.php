    ...
    <div class="cui__layout__content">
        <div class="cui__breadcrumbs">
            <div class="cui__breadcrumbs__path">
                ...
                <span>
                    <span class="cui__breadcrumbs__arrow"></span>
                    <strong class="cui__breadcrumbs__current">{{ $data->code }}</strong>
                </span>
            </div>
        </div>
        ...
        <div class="cui__utils__content">
            ...
            <div class="row">
                <div class="col-md-8">
                    <form id="form-data" method="post" action="{{ route('cms.pages.update', $data->id) }}">
                        @csrf @method('put')
                        <div class="card">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="code" maxlength="50"
                                        value="{{ old('code') ? old('code') : $data->code }}" name-validation="Code"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="name" maxlength="250"
                                        value="{{ old('name') ? old('name') : $data->{'name' . $curLanguage} }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="head_title" maxlength="250"
                                        value="{{ old('head_title') ? old('head_title') : $data->{'head_title' . $curLanguage} }}"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-8">
                                        ...
                                        <input class="form-control" type="text" name="route" maxlength="250"
                                            value="{{ old('route') ? old('route') : $data->route }}"
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input class="form-control text-right" type="number" name="order_dsp" maxlength="2"
                                            value="{{ old('order_dsp') ? old('order_dsp') : $data->order_dsp }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="kit__utils__control kit__utils__control__checkbox">
                                        <input type="checkbox" name="active_flg" @if ($data->active_flg) checked="checked" @endif>
                                        <span class="kit__utils__control__indicator"></span>
                                        {{ trans('text.active') }}
                                    </label>
                                    <label class="kit__utils__control kit__utils__control__checkbox">
                                        <input type="checkbox" name="cms_flg" @if ($data->cms_flg) checked="checked" @endif>
                                        <span class="kit__utils__control__indicator"></span>
                                        {{ trans('text.cms') }}
                                    </label>
                                </div>
