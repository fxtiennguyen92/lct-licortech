...
@push('content')
    <div class="cui__layout__content">
        ...
        <div class="cui__utils__content">
            ...
            <div class="row">
                <div class="col-md-8">
                    <form id="form-data" method="post" action="{{ route('cms.system.update', $data->id) }}">
                    @csrf @method('put')
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="value" name="value" rows="1">{!! old('value') ? old('value') : $data->value !!}</textarea>
                                </div>
