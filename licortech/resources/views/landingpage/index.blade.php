...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" async>
                    ...
                    <div class="rts-header__wrapper">
                        ...
                        <div class="rts-header__logo">
                            <a href="{{ route('home') }}" class="site-logo">
                                ...
                                <img class="logo-dark" src="{{ $common->web_logo }}" alt="{{ $common->web_name }}">
                            </a>
                        </div>
                        <!-- FOR NAVIGATION MENU -->
                        ...
                        <div class="rts-header__right">
                            <a href="{{ route('call') }}" class="login__btn ">{{ __('text.reserve_a_call') }}</a>
